...
public class Event3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseUser = FirebaseDatabase.getInstance().getReference("fault");
        ...
        logout.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                Intent i = new Intent(Event3.this,MainActivity.class);
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(email1.isEmpty()){
                    ...
                    Toast.makeText(Event3.this, "Fields cannot be empty", Toast.LENGTH_SHORT).show();
                }
                else if(!(email1.isEmpty() && name1.isEmpty() && phone1.isEmpty())){
                    if(!TextUtils.isEmpty(name1)){
                        ...
                        Toast.makeText(Event3.this, "User Registered", Toast.LENGTH_SHORT).show();
                    }else{
                        Toast.makeText(Event3.this, "Fields can't be empty", Toast.LENGTH_SHORT).show();
                    }
