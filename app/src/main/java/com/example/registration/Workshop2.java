...
public class Workshop2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseUser = FirebaseDatabase.getInstance().getReference("blockchain");
        logout.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                FirebaseAuth.getInstance().signOut();
                Intent i = new Intent(Workshop2.this,MainActivity.class);
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(email1.isEmpty()){
                    ...
                    Toast.makeText(Workshop2.this, "Fields cannot be empty", Toast.LENGTH_SHORT).show();
                }
                else if(!(email1.isEmpty() && name1.isEmpty() && phone1.isEmpty())){
                    if(!TextUtils.isEmpty(name1)){
                        ...
                        Toast.makeText(Workshop2.this, "User Registered", Toast.LENGTH_SHORT).show();
                    }else{
                        Toast.makeText(Workshop2.this, "Fields can't be empty", Toast.LENGTH_SHORT).show();
                    }
