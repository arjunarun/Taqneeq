...
public class Workshop3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseUser = FirebaseDatabase.getInstance().getReference("raspberry");
        logout.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                FirebaseAuth.getInstance().signOut();
                Intent i = new Intent(Workshop3.this,MainActivity.class);
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(email1.isEmpty()){
                    ...
                    Toast.makeText(Workshop3.this, "Fields cannot be empty", Toast.LENGTH_SHORT).show();
                }
                else if(!(email1.isEmpty() && name1.isEmpty() && phone1.isEmpty())){
                    if(!TextUtils.isEmpty(name1)){
                        ...
                        Toast.makeText(Workshop3.this, "User Registered", Toast.LENGTH_SHORT).show();
                    }else{
                        Toast.makeText(Workshop3.this, "Fields can't be empty", Toast.LENGTH_SHORT).show();
                    }
